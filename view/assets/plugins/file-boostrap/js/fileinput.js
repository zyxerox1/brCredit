...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tModalMain = '<div id="' + $h.MODAL_ID + '" class="file-zoom-dialog modal fade" ' +
                'tabindex="-1" data-backdrop="false" aria-labelledby="' + $h.MODAL_ID + 'Label"></div>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    zoomClass: 'btn btn-sm btn-kv btn-default btn-outline-primary',
    ...
    $.fn.fileinputLocales.en = {
        ...
        dropZoneClickTitle: '<br>(or Click para selecionar archivo {files})',
