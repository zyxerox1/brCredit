...
<div class="container">
    <br>
    <h4 class="btn-atras"><i class="fas fa-reply-all"></i> <i class="fas fa-times-circle"></i> Cierres</h4>
    <hr>
    <div class="row">
        <div class="col-md-6">
	...
	<div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="Estado" class="text-color">Estado de cierre</label>
                <select class="select-2 form-control" id="Estado" name="Estado" required="required">
                    <option value="111" selected="selected">Filtrar por estado</option>
                    <option value="1">Cerrado</option>
                    <option value="0">Pediente por cerrar</option>
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 offset-md-3 container-select2">
            ...
            <button type="button" class="btn btn-success btn-accion " id="cerrarTodo">Cerrar todo automaticos <i class="fas fa-calendar-alt"></i> </i></button>
        </div>
    </div>
    <br>
